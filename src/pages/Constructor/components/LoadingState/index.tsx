  ...
  return (
    <div className="h-full flex flex-col items-center justify-center">
      <Card className="w-full max-w-md p-8 text-center shadow-lg border border-primary/10 bg-white/95 backdrop-blur-sm relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#e8ebd9]/40 to-transparent pointer-events-none" />
        
        <h3 className="text-xl font-medium mb-4 text-primary">{CONSTRUCTOR_TEXT.APP_DEPLOYING}</h3>
        
        <div className="flex justify-center mb-6 relative">
          <div className="absolute -inset-2 bg-[#e8ebd9]/30 rounded-full blur-md animate-pulse" />
        ...
        <div className="space-y-3">
          <Progress 
            ...
            className="h-2.5 rounded-full overflow-hidden bg-[#e8ebd9]" 
          />
